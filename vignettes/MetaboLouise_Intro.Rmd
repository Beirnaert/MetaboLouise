...
For this let's use the *GetFoldChanges* function which calcluates the fold changes and plots the distribution.
...
Clearly, most nodes have roughly the same end state. However, some metaboltes (nodes) have a substantially increased ending 
